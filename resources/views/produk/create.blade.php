...
Modul Laravel | Eka Yuniar, S.Kom., MMSI
<input type="text" name="nama_produk" id="nama_produk" class="formcontrol">
</div>
<div class="form-group">
<label for="slug_produk">Slug Produk</label>
<input type="text" name="slug_produk" id="slug_produk" class="formcontrol">
</div>
<div class="form-group">
